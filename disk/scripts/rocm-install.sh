...
# services, GPU workloads) — exporting it only in cosim-gpu-setup.sh does not
# propagate to interactive/GPU processes (verified: HSA_XNACK was empty in the
# guest shell, so rocminfo reported xnack-). With HSA_XNACK=1 rocminfo reports
# gfx942:xnack+. See plan-xnack.md.
